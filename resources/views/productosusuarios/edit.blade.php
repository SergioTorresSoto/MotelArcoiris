...
<div class="container">
		    ...
		    <div class="panel panel-info">
              		...
              		<div class= "panel-body">
	                	{!! Form::open(['route' => ['productosusuarios.update',$detalleCompra],'method' => 'PUT', 'class' => 'form']) !!}
	                		<div class= "row">
		                		<div  class="col-sm-7">
			                		<div class="form-group">
			                			{!! Form::label('Proveedor', 'Proveedor') !!}
								 		
								 		{!! Form::select('id_cliente', $clientes, $productosComprados[0]->idUsuario, ['class' => 'form-control', 'placeholder' => 'Seleccione una opción...', 'required']) !!}
								...
								<div class="col-md-5">
									<div class="form-group">
							 			...
							 			{!! Form::select('tipo_comprobante', array('Efectivo' => 'Efectivo', 'Tarjeta' => 'Tarjeta'), $detalleCompra->tipo_comprobante,['class' => 'form-control', 'placeholder' => 'Seleccione una opcion...']) !!}
